"""Iren Luce Gas e Servizi — offerte gas.
...
l'artifact debug/iren_gas.html.
...
def parse_html(html: str, commodity: str) -> list[Offer]:
    """TODO: estrazione reale per iren (gas). Vuoto finché non implementata."""
    offers = []
...
if __name__ == "__main__":
    cli_main("gas", "iren", "Iren Luce Gas e Servizi", scrape)
