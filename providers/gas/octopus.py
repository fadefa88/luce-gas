...
l'artifact debug/octopus_gas.html.
...
def parse_html(html: str, commodity: str) -> list[Offer]:
    """TODO: estrazione reale per octopus (gas). Vuoto finché non implementata."""
    offers = []
...
if __name__ == "__main__":
    cli_main("gas", "octopus", "Octopus Energy", scrape)
