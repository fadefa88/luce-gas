...
l'artifact debug/edison_gas.html.
...
def parse_html(html: str, commodity: str) -> list[Offer]:
    """TODO: estrazione reale per edison (gas). Vuoto finché non implementata."""
    offers = []
...
if __name__ == "__main__":
    cli_main("gas", "edison", "Edison Energia", scrape)
