...
l'artifact debug/enel_luce.html.
...
def parse_html(html: str, commodity: str) -> list[Offer]:
    """TODO: estrazione reale per enel (luce). Vuoto finché non implementata."""
    offers = []
...
if __name__ == "__main__":
    cli_main("luce", "enel", "Enel Energia", scrape)
