"""Iren Luce Gas e Servizi — offerte luce.

Pagina: https://www.irenlucegas.it/casa
...
l'artifact debug/iren_luce.html.
...
URL = "https://www.irenlucegas.it/casa"


def parse_html(html: str, commodity: str) -> list[Offer]:
    """TODO: estrazione reale per iren (luce). Vuoto finché non implementata."""
    offers = []
    ...
    #     offers.append(Offer(operatore="Iren Luce Gas e Servizi", offerta="...", url=URL,
...
if __name__ == "__main__":
    cli_main("luce", "iren", "Iren Luce Gas e Servizi", scrape)
