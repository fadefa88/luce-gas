"""Edison Energia — offerte luce.

Pagina: https://www.edisonenergia.it/edison/luce-gas-servizi
...
l'artifact debug/edison_luce.html.
...
URL = "https://www.edisonenergia.it/edison/luce-gas-servizi"


def parse_html(html: str, commodity: str) -> list[Offer]:
    """TODO: estrazione reale per edison (luce). Vuoto finché non implementata."""
    offers = []
    ...
    #     offers.append(Offer(operatore="Edison Energia", offerta="...", url=URL,
...
if __name__ == "__main__":
    cli_main("luce", "edison", "Edison Energia", scrape)
