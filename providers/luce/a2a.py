...
l'artifact debug/a2a_luce.html.
...
def parse_html(html: str, commodity: str) -> list[Offer]:
    """TODO: estrazione reale per a2a (luce). Vuoto finché non implementata."""
    offers = []
...
if __name__ == "__main__":
    cli_main("luce", "a2a", "A2A Energia", scrape)
