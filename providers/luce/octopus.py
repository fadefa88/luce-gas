"""Octopus Energy — offerte luce.

Pagina: https://octopusenergy.it/le-nostre-tariffe
...
l'artifact debug/octopus_luce.html.
...
def parse_html(html: str, commodity: str) -> list[Offer]:
    """TODO: estrazione reale per octopus (luce). Vuoto finché non implementata."""
    offers = []
    ...
    #     offers.append(Offer(operatore="Octopus Energy", offerta="...", url=URL,
...
if __name__ == "__main__":
    cli_main("luce", "octopus", "Octopus Energy", scrape)
