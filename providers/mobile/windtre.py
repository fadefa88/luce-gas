...
debug/windtre.html e scrivi qui i selettori giusti in parse_html().
"""
...
VERIFIED = [('200 Giga', 200, 10.99, 0.0, '50', 'provenendo da altro operatore')]
...
def _verified_offers() -> list[Offer]:
    ...
    for nome, giga, prezzo, att, sms, note in VERIFIED:
        out.append(Offer(
            operatore="WindTre", offerta=nome, url=URL,
...
def parse_html(html: str) -> list[Offer]:
    """TODO: estrazione reale calibrata su windtre. Vuoto finché non implementata."""
    return []
