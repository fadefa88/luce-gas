...
debug/coopvoce.html e scrivi qui i selettori giusti in parse_html().
"""
...
VERIFIED = [('Turbo 200', 200, 7.9, 0.0, '1000', "attivazione + 1° mese gratuiti; promo fino all'01/07"), ('Turbo 400', 400, 9.9, 0.0, '1000', '')]
...
def _verified_offers() -> list[Offer]:
    ...
    for nome, giga, prezzo, att, sms, note in VERIFIED:
        out.append(Offer(
            operatore="CoopVoce", offerta=nome, url=URL,
...
def parse_html(html: str) -> list[Offer]:
    """TODO: estrazione reale calibrata su coopvoce. Vuoto finché non implementata."""
    return []
