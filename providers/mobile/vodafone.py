...
debug/vodafone.html e scrivi qui i selettori giusti in parse_html().
"""
...
VERIFIED = [('400 Giga', 400, 14.95, 10.0, '200', ''), ('250 Giga', 250, 11.95, 10.0, '200', ''), ('150 Giga', 150, 9.95, 10.0, '200', '')]
...
def _verified_offers() -> list[Offer]:
    ...
    for nome, giga, prezzo, att, sms, note in VERIFIED:
        out.append(Offer(
            operatore="Vodafone", offerta=nome, url=URL,
...
def parse_html(html: str) -> list[Offer]:
    """TODO: estrazione reale calibrata su vodafone. Vuoto finché non implementata."""
    return []
...
if __name__ == "__main__":
    cli_main("mobile", "vodafone", "Vodafone", scrape)
