...
debug/postemobile.html e scrivi qui i selettori giusti in parse_html().
"""
...
def _verified_offers() -> list[Offer]:
    ...
    for nome, giga, prezzo, att, sms, note in VERIFIED:
        out.append(Offer(
            operatore="PosteMobile", offerta=nome, url=URL,
...
def parse_html(html: str) -> list[Offer]:
    """TODO: estrazione reale calibrata su postemobile. Vuoto finché non implementata."""
    return []
