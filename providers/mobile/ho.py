...
debug/ho.html e scrivi qui i selettori giusti in parse_html().
"""
...
VERIFIED = [('150 Giga 5G', 150, 9.95, 2.99, '200', ''), ('250 Giga 5G', 250, 11.95, 2.99, '200', '')]
...
def _verified_offers() -> list[Offer]:
    ...
    for nome, giga, prezzo, att, sms, note in VERIFIED:
        out.append(Offer(
            operatore="ho. Mobile", offerta=nome, url=URL,
...
def parse_html(html: str) -> list[Offer]:
    """TODO: estrazione reale calibrata su ho. Vuoto finché non implementata."""
    return []
...
if __name__ == "__main__":
    cli_main("mobile", "ho", "ho. Mobile", scrape)
