"""Digi Mobil — offerte mobile.

Pagina: https://www.digimobil.it/
...
debug/digi.html e scrivi qui i selettori giusti in parse_html().
"""
...
def _verified_offers() -> list[Offer]:
    ...
    for nome, giga, prezzo, att, sms, note in VERIFIED:
        out.append(Offer(
            operatore="Digi Mobil", offerta=nome, url=URL,
...
def parse_html(html: str) -> list[Offer]:
    """TODO: estrazione reale calibrata su digi. Vuoto finché non implementata."""
    return []
...
if __name__ == "__main__":
    cli_main("mobile", "digi", "Digi Mobil", scrape)
