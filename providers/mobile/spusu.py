...
debug/spusu.html e scrivi qui i selettori giusti in parse_html().
"""
...
VERIFIED = [('spusu 200 XL', 200, 7.89, 0.0, '500', '+400 GB riserva; offerta fino al 30/06'), ('spusu 500 XXL', 500, 12.98, 0.0, '500', '+500 GB riserva')]
...
def _verified_offers() -> list[Offer]:
    ...
    for nome, giga, prezzo, att, sms, note in VERIFIED:
        out.append(Offer(
            operatore="spusu", offerta=nome, url=URL,
...
def parse_html(html: str) -> list[Offer]:
    """TODO: estrazione reale calibrata su spusu. Vuoto finché non implementata."""
    return []
...
if __name__ == "__main__":
    cli_main("mobile", "spusu", "spusu", scrape)
